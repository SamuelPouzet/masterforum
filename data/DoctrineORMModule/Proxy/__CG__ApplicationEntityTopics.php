 ...
 */
class Topics extends \Application\Entity\Topics implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'date_create', 'forum_id', 'forum', 'subjects'];
        }
     ...
     * {@inheritDoc}
     */
    public function addSubject(\Application\Entity\Subjects $subject)
    {
